...
class Application extends Container implements HttpKernelInterface, ResponsePreparerInterface
{
    ...
    {
        return 'D:\\boris\\work\\localdomains\\laravel\\vendor\\laravel\\framework\\src\\Illuminate\\Foundation' . '/start.php';
    }
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = 'D:\\boris\\work\\localdomains\\laravel\\vendor\\filp\\whoops\\src\\Whoops\\Handler' . '/../Resources';
        }

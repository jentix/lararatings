					...
					<table width="600" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
						<tr>
							...
							<td width="560"> <!--style="border: 1px solid #000;">-->
								...
								<p>Вы успешно зарегистрировались на сайте <a href="http://rating.fryazino.net" target="_blank" style="color: #0987cb;">rating.fryazino.net</a></p>
								<p>Ваш логин: {{$email}}</p>
								<p>Что-бы подтвердить регистрацию перейдите по этой ссылке 
							    <a href="http://rating.fryazino.net/?key={{$hash}}" target="_blank" style="color: #0987cb;">ПОДТВЕРДИТЬ</a></p>	
							</td>
							<td width="45">
								<div style="margin: 0; padding: 0; line-height: 0;"><img src="http://rating.fryazino.net/img/empty.gif" border="0" width="1" height="1" style="display: block;" alt="" /></div>
							</td>

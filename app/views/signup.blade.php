...
@section('content')
	...
	<div class="myspoiler">
		...
		<p>Электронная почта должна быть действующий и обязательно подтвержденной.</p>
		<p>Название сайта должно отражать его суть.</p>
		<p>Ссылка на сайт должна быть действующий.</p>
		<p>Запрещено использование нецензурной лексики.</p>
		<p>Запрещено употребление эпитетов и утверждений рекламного характера, а также прилагательных в превосходной степени, ссылок на сайт в название и описание сайта.</p>
		<p>Запрещена накрутка счётчиков.</p>
		<p>Запрещено размещение одного счётчика на нескольких сайтах.</p>
		<p>При удаление сайта с рейтинга, без отключения сайта, необходимо удалить счётчик с сайта.</p>
		...
		<p>При некорректном имени или описании сайта администрация в праве отредактировать его.</p>
	</div>
	@if (isset($messages))

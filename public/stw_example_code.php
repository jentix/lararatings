<?php
    /**
        Библиоткеа делает превью сайтов
     ...
     */
    define('ACCESS_KEY', 'ab0456478855090');
    define('SECRET_KEY', 'a7980');
    define('THUMBNAIL_URI', '');
	...
	/****************************************************************
	*	Example of a request when viewing this page in a browser.	*
	*	It is IMPORTANT that this block come here, because the		*
	*	"define" parameters are required at the top to load first!	*
	****************************************************************/	
